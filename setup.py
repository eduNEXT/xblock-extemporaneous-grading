#!/usr/bin/env python
"""
Package metadata for extemporaneous_grading.
"""
import os
import re
import sys
...
VERSION = get_version('extemporaneous_grading', '__init__.py')
...
setup(
    name='xblock-extemporaneous-grading',
    version=VERSION,
    description="""Extemporaneous Grading XBlock""",
