...
"""
xblock-extemporaneous-grading documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'xblock-extemporaneous-grading',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/edunext/xblock-extemporaneous-grading",
...
#
# html_title = 'xblock-extemporaneous-grading v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Extemporaneous Grading XBlock',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'extemporaneous_grading'),
                os.path.join(root_path, 'extemporaneous_grading/migrations')])
